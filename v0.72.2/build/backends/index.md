...
Build backends never base their behavior on the dependencies declared in the Pixi manifest. Manifest dependencies are only converted into recipe requirements; backend behavior is controlled by:
