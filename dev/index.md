...
- [💾 **Disk Efficient**](workspace/environment/#de-duplication) Environments share files through hard links or reflinks, so packages are stored only once.
...
- **Node.js**: [`nodejs`](https://prefix.dev/channels/conda-forge/packages/nodejs), \[`bun`\]([https://](https://prefix.dev/channels/conda-forge/packages/bun), [`pnpm`](https://prefix.dev/channels/conda-forge/packages/pnpm), [`eslint`](https://prefix.dev/channels/conda-forge/packages/eslint)
