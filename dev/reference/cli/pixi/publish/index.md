...
`pixi publish` is a convenience command that **builds** a conda package from your workspace and **uploads** it to a channel in a single step. It combines the functionality of [`pixi build`](../build/) and [`pixi upload`](../upload/).
...
- [`--to <TO>`](#arg---to) : The target channel URL to publish packages to
