...
To activate the environment in Bash or Zsh: `bash eval "$(pixi shell-hook)"`

To activate the environment in PowerShell: `powershell pixi shell-hook | Invoke-Expression`
