...
| Running a standalone script | `uv run script.py` (PEP 723) | `pixi exec` via [shebang](../../advanced/shebang/)                   |
...
Pixi has a similar capability via [shebang scripts](../../advanced/shebang/) using `pixi exec`, which creates a temporary environment with the specified dependencies:
