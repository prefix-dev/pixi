...
1. **Fast**. We want to have a fast package manager, that is able to solve the installation environment in a few seconds.
...
3. **Isolated Environment**. We want to have isolated installation environments, that are reproducible and easy to share. Ideally, it should run on all common platforms. The Conda packaging system provides an excellent base for this.
