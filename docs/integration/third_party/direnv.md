...
direnv: export +CONDA_DEFAULT_ENV +CONDA_PREFIX +PIXI_ENVIRONMENT_CURRENT_PLATFORM +PIXI_ENVIRONMENT_CURRENT_SUBDIR +PIXI_ENVIRONMENT_CURRENT_VIRTUAL_PACKAGES +PIXI_ENVIRONMENT_NAME +PIXI_ENVIRONMENT_PLATFORMS +PIXI_PROJECT_MANIFEST +PIXI_PROJECT_NAME +PIXI_PROJECT_ROOT +PIXI_PROJECT_VERSION +PIXI_PROMPT ~PATH
$ which python
