...
- [`pixi run`](./reference/cli/pixi/run.md) - run a task defined in your manifest or any command in the current installation environment
- [`pixi shell`](./reference/cli/pixi/shell.md) - start a shell in the current installation environment
- [`pixi list`](./reference/cli/pixi/list.md) - list all dependencies in the current installation environment
- [`pixi tree`](./reference/cli/pixi/tree.md) - show a tree of dependencies in the current installation environment
- [`pixi clean`](./reference/cli/pixi/clean.md) - remove the environment from your machine

## Managing global installations

Pixi can manage global installations of tools in global installation environments.
It installs the installation environments in a central location, so you can use them from anywhere.

- [`pixi global install`](./reference/cli/pixi/global/install.md) - install a package into it's own installation environment in the global space.
- [`pixi global uninstall`](./reference/cli/pixi/global/uninstall.md) - uninstall an installation environment from the global space.
- [`pixi global add`](./reference/cli/pixi/global/add.md) - add a package to an existing global installation environment.
...
- [`pixi global update`](./reference/cli/pixi/global/update.md) - update the global installation environments
- [`pixi global list`](./reference/cli/pixi/global/list.md) - list all the global installation environments

More information: [Global Tools](./global_tools/introduction.md)

## Running one-off commands

Pixi can run one-off commands in a specific installation environment.

- [`pixi exec`](./reference/cli/pixi/exec.md) - run a command in a temporary installation environment.
- [`pixi exec --spec`](./reference/cli/pixi/exec.md#arg---spec)   - run a command in a temporary installation environment, with a specific specification.
...
Pixi workspaces allow you to manage multiple installation environments.
An installation environment is build out of one or multiple features.
...
- [`pixi workspace environment add`](./reference/cli/pixi/workspace/environment/add.md) - add an installation environment to the workspace
- [`pixi run --environment`](./reference/cli/pixi/run.md#arg---environment) - run a command in a specific installation environment
- [`pixi shell --environment`](./reference/cli/pixi/shell.md#arg---environment) - activate a specific installation environment
- [`pixi list --environment`](./reference/cli/pixi/list.md#arg---environment) - list the dependencies in a specific installation environment

More information: [Multiple Installation Environments](./workspace/multi_environment.md)
...
- [`pixi tree`](./reference/cli/pixi/tree.md) - Show a tree of dependencies in the current installation environment.
- [`pixi list`](./reference/cli/pixi/list.md) - List all dependencies in the current installation environment.
- [`pixi clean`](./reference/cli/pixi/clean.md) - Remove the workspace installation environments from your machine.
