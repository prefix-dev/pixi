...
See [`pixi workspace platform`](reference/cli/pixi/workspace/platform/index.md) for the full list of friendly virtual-package keys (`cuda`, `glibc`, `macos`, …) and for editing or removing entries.
