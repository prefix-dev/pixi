...
# [pixi](../../index.md) [workspace](../index.md) environment
...
| Command | Description |
|---------|-------------|
| [`add`](add.md) | Adds an environment to the manifest file |
| [`list`](list.md) | List the environments in the manifest file |
| [`remove`](remove.md) | Remove an environment from the manifest file |
