...
# [pixi](../../index.md) [workspace](../index.md) requires-pixi
...
| Command | Description |
|---------|-------------|
| [`get`](get.md) | Get the pixi minimum version requirement |
| [`set`](set.md) | Set the pixi minimum version requirement |
| [`unset`](unset.md) | Remove the pixi minimum version requirement |
| [`verify`](verify.md) | Verify the pixi minimum version requirement |
