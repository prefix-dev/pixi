...
# [pixi](../../index.md) [workspace](../index.md) register
...
| Command | Description |
|---------|-------------|
| [`list`](list.md) | List the registered workspaces |
| [`remove`](remove.md) | Remove a workspace from registry |
| [`prune`](prune.md) | Prune disassociated workspaces from registry |
