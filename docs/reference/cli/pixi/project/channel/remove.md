# <code>[pixi](../../../pixi.md) [project](../../project.md) [channel](../channel.md) remove</code>

## About
Remove channel(s) from the project file and updates the lockfile

--8<-- "docs/reference/cli/pixi/project/channel/remove_extender.md:description"

## Usage
```
pixi project channel remove [OPTIONS] <CHANNEL>...
```
...
--8<-- "docs/reference/cli/pixi/project/channel/remove_extender.md:example"
