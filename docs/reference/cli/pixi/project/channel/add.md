# <code>[pixi](../../../pixi.md) [project](../../project.md) [channel](../channel.md) add</code>

## About
Adds a channel to the project file and updates the lockfile

--8<-- "docs/reference/cli/pixi/project/channel/add_extender.md:description"

## Usage
```
pixi project channel add [OPTIONS] <CHANNEL>...
```
...
--8<-- "docs/reference/cli/pixi/project/channel/add_extender.md:example"
