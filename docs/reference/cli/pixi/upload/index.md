...
| Command | Description |
|---------|-------------|
| [`quetz`](quetz.md) | Upload to a Quetz server. Authentication is used from the keychain / auth-file |
| [`artifactory`](artifactory.md) | Options for uploading to an Artifactory channel |
| [`prefix`](prefix.md) | Options for uploading to a prefix.dev server. Authentication is used from the keychain / auth-file |
| [`anaconda`](anaconda.md) | Options for uploading to a Anaconda.org server |
| [`cloudsmith`](cloudsmith.md) | Options for uploading to a Cloudsmith repository. Authentication is used from the keychain / auth-file |
| [`s3`](s3.md) | Options for uploading to S3 |
