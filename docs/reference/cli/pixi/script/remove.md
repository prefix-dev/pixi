---
title: pixi script remove
---
<!--- This file is autogenerated. Do not edit manually! -->
# [pixi](../../pixi.md) [script](../script.md) remove

Remove dependencies from a script

--8<-- "docs/reference/cli/pixi/script/remove_extender:description"

## Usage
```
pixi script remove [OPTIONS] <PATH> <NAME>...
```
...
--8<-- "docs/reference/cli/pixi/script/remove_extender:example"
