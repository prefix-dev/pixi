...
| Command | Description |
|---------|-------------|
| [`add`](add.md) | Add a command to the workspace |
| [`remove`](remove.md) | Remove a command from the workspace |
| [`alias`](alias.md) | Alias another specific command |
| [`list`](list.md) | List all tasks in the workspace |
