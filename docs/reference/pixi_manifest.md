...
--8<-- "docs/reference/_schema_tables.md:workspace"
...
--8<-- "docs/reference/_schema_tables.md:tasks"
...
--8<-- "docs/reference/_schema_tables.md:system_requirements"
...
--8<-- "docs/reference/_schema_tables.md:pypi_options"
...
--8<-- "docs/reference/_schema_tables.md:dependencies"
...
--8<-- "docs/reference/_schema_tables.md:activation"
...
--8<-- "docs/reference/_schema_tables.md:target"
...
--8<-- "docs/reference/_schema_tables.md:feature"
...
--8<-- "docs/reference/_schema_tables.md:environments"
...
--8<-- "docs/reference/_schema_tables.md:package"
...
--8<-- "docs/reference/_schema_tables.md:package_build"
