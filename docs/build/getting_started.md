...
=== "pyproject.toml"
    ...
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:full"
    ```
...
=== "pyproject.toml"
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:preview"
    ```
...
=== "pyproject.toml"
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:package"
    ```
...
=== "pyproject.toml"
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:build-system"
    ```
...
=== "pyproject.toml"
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:dependencies"
    ```
...
=== "pyproject.toml"
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:host-dependencies"
    ```
...
=== "pyproject.toml"
    ```toml
    --8<-- "docs/source_files/pyproject_tomls/getting_started_pixi.toml:run-dependencies"
    ```
