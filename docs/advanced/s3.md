...
You can also use public S3 buckets without authentication.
For this, you need to configure your S3 bucket in such a way that it allows public access.
On AWS, for example, you need the `GetObject` and `ListBucket` permissions for this.
Here is an example for AWS S3:
