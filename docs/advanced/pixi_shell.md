...
the installation environment. If you would peek under the hood of the the `shell` command, then you
...
if the installation environment was activated successfully. If we do not receive this string after
...
installation environment won't be activated.
