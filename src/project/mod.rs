...
impl Project {
    ...
    /// Get or initialize the activated environment variables. If a lock file is provided,
    /// caching is performed for the environment variables from the activation.
