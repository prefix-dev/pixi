...
use crate::global::common::{EnvironmentUpdate, InstallChange, check_all_exposed};
...
fn report_dry_run_environment_update(
    ...
    environment_update: &crate::global::common::EnvironmentUpdate,
) {
...
pub async fn execute(args: Args) -> miette::Result<()> {
    ...
    async fn apply_changes(
        ...
        StateChanges,
        Option<crate::global::common::EnvironmentUpdate>,
    )> {
