...
const GITIGNORE_TEMPLATE: &str = r#"# Generated by pixi init
*
...
pub async fn execute(args: Args) -> miette::Result<()> {
    ...
    let gitignore_path = dir.join(consts::PIXI_FOLDER_PATH).join(".gitignore");
    ...
    // create a .gitignore in the pixi folder
    if !gitignore_path.is_file() {
        fs::create_dir_all(gitignore_path.parent().ok_or(miette!(
            "can not find parent of gitignore path: {}",
