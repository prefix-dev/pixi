...
class TaskInlineTable(StrictBaseModel):
    ...
    inputs: list[Glob] | None = Field(
        None,
        description="A list of glob patterns that should be watched for changes before this command is run. Environment variables _will_ be expanded.",
    )
    outputs: list[Glob] | None = Field(
        None, description="A list of glob patterns that are generated by this command. Environment variables _will_ be expanded."
    )
