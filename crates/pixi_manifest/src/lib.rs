...
pub use manifests::{
    ActivationScriptsChange, AssociateProvenance, ManifestKind, ManifestProvenance,
    ManifestSource, MissingTargetError, PackageManifest, ProvenanceError, RemoveDependencyError,
