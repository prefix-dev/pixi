...
mod tests {
    use super::*;
    use pixi_config::{
        CacheConfig, ConcurrencyConfig, ExperimentalConfig, IndexChannelConfig, IndexConfig,
        ProxyConfig, PyPIConfig, RepodataChannelConfig, RepodataConfig, ShellConfig, TlsRootCerts,
    };
