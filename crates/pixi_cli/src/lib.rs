...
impl GlobalOptions {
    /// How much detail the reports of `pixi global` show.
    ///
    /// This rides along with the logging flags rather than having a knob of its
    /// own: someone asking for more verbosity wants the whole picture, and
    /// someone asking for quiet wants nothing but the failures.
