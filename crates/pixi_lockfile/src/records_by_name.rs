...
use crate::{PypiPackageIdentifier, PypiRecord};
...
impl<D: HasNameVersion> DependencyRecordsByName<D> {
    ...
    /// instance.
    pub fn names(&self) -> impl Iterator<Item = &D::N> {
