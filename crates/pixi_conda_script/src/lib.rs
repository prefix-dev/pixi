//! Parsing for the `conda-script` metadata block: conda channels,
//! dependencies and an entrypoint embedded in a comment block of any code
//! file, as proposed in <https://github.com/prefix-dev/pixi/issues/3751>.
//!
