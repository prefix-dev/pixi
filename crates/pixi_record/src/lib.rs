...
pub use source_record::{
    FullSourceRecord as SourceRecord, FullSourceRecordData, PinnedBuildSourceSpec,
    PartialSourceRecord, PartialSourceRecordData, SourceRecordData, UnresolvedSourceRecord,
};
use thiserror::Error;
    ...
    pub fn from_conda_package_data(
        ...
        match data {
            CondaPackageData::Binary(value) => {
                ...
                Ok(UnresolvedPixiRecord::Binary(
                    value.try_into().map_err(|err| match err {
